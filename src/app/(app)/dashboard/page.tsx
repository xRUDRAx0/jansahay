      ...
      {showHackathonLoader && (
        <section className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-100 rounded-2xl p-6 shadow-sm">
          ...
          <div className="flex flex-wrap gap-4">
            <button 
              onClick={() => updateCitizenProfile(require('@/lib/demo/personas').demoPersonas.student)}
              className="flex-1 min-w-[200px] px-4 py-3 bg-white border border-blue-200 rounded-xl hover:border-blue-500 hover:shadow-md transition-all text-left"
            >
              <div className="font-bold text-blue-900">🎓 Student Persona</div>
              <div className="text-xs text-gray-500 mt-1">19yo B.Tech • ₹2L Income</div>
            </button>
            <button 
              onClick={() => updateCitizenProfile(require('@/lib/demo/personas').demoPersonas.farmer)}
              className="flex-1 min-w-[200px] px-4 py-3 bg-white border border-green-200 rounded-xl hover:border-green-500 hover:shadow-md transition-all text-left"
            >
              <div className="font-bold text-green-900">🌾 Farmer Persona</div>
              <div className="text-xs text-gray-500 mt-1">45yo • 3 Acres • Crop Damage</div>
            </button>
            <button 
              onClick={() => updateCitizenProfile(require('@/lib/demo/personas').demoPersonas.senior)}
              className="flex-1 min-w-[200px] px-4 py-3 bg-white border border-purple-200 rounded-xl hover:border-purple-500 hover:shadow-md transition-all text-left"
            >
              <div className="font-bold text-purple-900">👵 Senior Persona</div>
              <div className="text-xs text-gray-500 mt-1">68yo • Widow • ₹45k Income</div>
            </button>
          </div>
          <div className="mt-4 pt-4 border-t border-blue-200 flex justify-between items-center">
            <span className="text-sm text-gray-500">Or talk to the agent to build your own profile.</span>
            <Link href="/agent">
              <button className="px-5 py-2 bg-blue-600 text-white rounded-lg text-sm font-semibold hover:bg-blue-700 transition-colors">
                Start Fresh Session
              </button>
            </Link>
          </div>
